      ...
      h('tbody', dayDatas.map(rows => {
        return h('tr', rows.map(item => {
          return h('td', {
            ...
            onClick: _vm.dateSelectEvent(item),
            onMouseenter: _vm.dateMouseenterEvent(item),
    ...
    h('div', {
      ...
      h('div', {
        ...
        datePanelType === 'year' ? h('span', {
          ...
          onClick: _vm.dateToggleTypeEvent,
      ...
      h('div', {
        ...
        h('span', {
          ...
          onClick: _vm.dateTodayMonthEvent,
        }, [
          h('i', {
            class: 'vxe-icon--dot'
          })
    ...
    h('div', {
      ...
      h('ul', {
        ...
        return h('li', {
          ...
          onClick: (evnt) => _vm.dateHourEvent(evnt, item),
        }, item.label)
      })),
      h('ul', {
        ...
        return h('li', {
          ...
          onClick: (evnt) => _vm.dateMinuteEvent(evnt, item),
        }, item.label)
      })),
      h('ul', {
        ...
        return h('li', {
          ...
          onClick: (evnt) => _vm.dateSecondEvent(evnt, item),
        }, item.label)
      }))
    ])
  ]
...
function renderNumberIcon (h, _vm) {
  return h('span', {
    ...
    h('span', {
      ...
      onMousedown: _vm.numberMousedownEvent,
      onMouseup: _vm.numberStopDown,
      onMouseleave: _vm.numberStopDown
    }, [
      h('i', {
...
function renderDatePickerIcon (h, _vm) {
  return h('span', {
    ...
    onClick: _vm.datePickerOpenEvent
  }, [
    h('i', {
...
function renderPasswordIcon (h, _vm) {
  ...
  return h('span', {
    ...
    onClick: _vm.passwordToggleEvent
  }, [
    h('i', {
...
function rendePrefixIcon (h, _vm) {
  const { $slots, prefixIcon } = _vm
  const icons = []
  if ($slots.prefix) {
    icons.push(
      h('span', {
        class: 'vxe-input--prefix-icon'
      }, $slots.prefix.call(this, {}, h))
    )
  } else if (prefixIcon) {
    icons.push(
      h('i', {
  ...
  return icons.length ? h('span', {
    ...
    onClick: _vm.clickPrefixEvent
  }, icons) : null
}

function renderSuffixIcon (h, _vm) {
  const { $slots, value, isClearable, disabled, suffixIcon } = _vm
  const icons = []
  if ($slots.suffix) {
    icons.push(
      h('span', {
        class: 'vxe-input--suffix-icon'
      }, $slots.suffix.call(this, {}, h))
    )
  } else if (suffixIcon) {
    icons.push(
      h('i', {
        class: ['vxe-input--suffix-icon', suffixIcon],
        innerHTML: `<svg width="12px" height="6px" viewBox="0 0 12 6" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <g id="页面-2" stroke="none" stroke-width="1" fill-rule="evenodd">
            <path d="M6.00332326,6 C6.18277946,6 6.3489426,5.92332268 6.47522659,5.79552716 L11.3138973,1.03514377 C11.4335347,0.920127796 11.5,0.773162939 11.5,0.607028754 C11.5,0.261980831 11.2274924,0 10.8685801,0 C10.7024169,0 10.5362538,0.0638977636 10.4166163,0.178913738 L6.00332326,4.52396166 L1.58338369,0.178913738 C1.46374622,0.0638977636 1.31087613,0 1.13141994,0 C0.779154079,0 0.5,0.261980831 0.5,0.607028754 C0.5,0.773162939 0.566465257,0.920127796 0.686102719,1.03514377 L5.52477341,5.79552716 C5.66435045,5.92971246 5.81722054,6 6.00332326,6 Z" id="2"></path>
          </g>
        </svg>`
      })
    )
...
export default {
  ...
  computed: {
    ...
    inpEvents () {
      const evnts = {}
      XEUtils.each(this.$attrs, (cb, name) => {
      ...
      if (this.isNumber) {
        ...
        evnts.onClick = this.clickEvent
      }
      evnts.onInput = this.inputEvent
      evnts.onFocus = this.focusEvent
      evnts.onBlur = this.blurEvent
      return evnts
    }
  },
  watch: {
