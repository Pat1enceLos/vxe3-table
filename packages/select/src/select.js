  ...
  render () {
    ...
    return h('div', {
      ...
      h(resolveComponent('vxe-input'), {
        ...
        onClick: this.togglePanelEvent,
        onFocus: this.focusEvent,
        onBlur: this.blurEvent,
        onSuffixClick: this.togglePanelEvent
      }),
      h('div', {
        ref: 'panel',
        ...
        }, (this.$slots.default && this.$slots.default()) || (optionGroups ? renderOptgroup(h, this) : renderOption(h, this, this.options)))
      ])
    ])
  },
  methods: {
