...
const eventTypes = 'created,mounted,activated,beforeUnmount,unmounted,event.clearActived,event.clearFilter,event.showMenu,event.keydown,event.export,event.import'.split(',').map(toType)
const storeMap = {}
