...
var ColumnConfig = /*#__PURE__*/function () {
  ...
  function ColumnConfig($xetable, _vm) {
    ...
    if (formatter) {
      if (_xeUtils.default.isString(formatter)) {
        var globalFunc = _formats.default.get(formatter) || _xeUtils.default[formatter];
        ...
        var _globalFunc = _formats.default.get(formatter[0]) || _xeUtils.default[formatter[0]];
  ...
  _createClass(ColumnConfig, [{
    ...
    value: function getTitle() {
      return UtilTools.getFuncText(this.own.title || (this.type === 'seq' ? _conf.default.i18n('vxe.table.seqTitle') : ''));
    }
  }, {
    key: "getKey",
