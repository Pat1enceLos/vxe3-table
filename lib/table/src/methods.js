...
var _methods = require("xe-utils/methods");
...
var Methods = {
  ...
  updateAfterFullData: function updateAfterFullData() {
    ...
    if (column && column.order) {
      ...
      var isRemote = _xeUtils.default.isBoolean(remoteSort) ? remoteSort : sortOpts.remote;
      ...
      if (!isRemote) {
        if (allSortMethod && !sortMethod) {
          ...
          var rest = sortMethod ? tableData.sort(sortMethod) : _xeUtils.default.sortBy(tableData, column.sortBy || (column.formatter ? function (row) {
      ...
      if (reserve) {
        if (value) {
          selectRows.forEach(function (row) {
            checkboxReserveRowMap[_tools.UtilTools.getRowid(_this24, row)] = row;
          });
        } else {
  ...
  handleAsyncRowExpand: function handleAsyncRowExpand(row) {
    ...
    return new Promise(function (resolve) {
      ...
      _this29.expandOpts.loadMethod({
        ...
        _xeUtils.default.remove(_this29.expandLazyLoadeds, function (item) {
          return item === row;
        });
    ...
    return this.$nextTick().then(function () {
      ...
      if (scope && $refs.tableBody && editRules) {
        ...
        if (_this40.hasCellRules(type, row, column)) {
          ...
          var cell = _tools.DomTools.getCell(_this40, {
            row: row,
            rowIndex: rowIndex,
            column: column
          });
  ...
  calcTableWidth: function calcTableWidth() {
    ...
    this.$nextTick(function () {
        ...
        entries.forEach(function (entry) {
          _this41.$nextTick(function () {
            ...
            if (_this41.$refs[ref] && _this41.$refs[ref].clientWidth) {
              ...
              var _sumExceptLast = _xeUtils.default.sum(_this41.dropRight(columns.map(function (i) {
                return i.width;
              })));
      ...
      var sumExceptLast = _xeUtils.default.sum(_this41.dropRight(storedData[key]));
      ...
      _this41.recordWidth = _xeUtils.default.sum(storedData[key]);
      localStorage.setItem('columnWidth', JSON.stringify(storedData));
      setTimeout(function () {
